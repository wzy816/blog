...
| ----- | ----------------------------------------------------------------------------------------------------------------------------- |
| 2023  |                                                                                                                               |
| 05-15 | basic transformer understanding<br>nanoGPT on shakespear text generation<br>gpt4all train gptj6B w/ lora<br>streamlit chatbot |
...
| 08-07 | 推理效果一般                                                                       |
| 08-08 | 扩展参数量到 447M，vocab 设为 32000/16000<br>调整 lr 和 micro、bs，loss 下降很光滑 |
...
| 12-19 | loss=2，下不去                                                                                                    |
| 2024  |                                                                                                                   |
| 01-04 | retrain， fix 数据集问题，loss=1.82，推理效果不错                                                                 |
...
| ----- | --------------------------------------------------------------------------------------------- |
| 2025  |                                                                                               |
| 02-11 | read deepseek r1 paper<br>qwen2.5-0.5B with GRPO, but oom                                     |
