...
> 就是如果今天我是一个 a i 创业公司的CEO，我怎么去面对头上的这几个模型公司的竞争？我手上是没有硬牌的，只能硬着头皮往前走的。

> 上一代的产品经理很多都是码农出身，就码农出身的人，其实他们能知道哪些功能是可以实现的？但所以你看，所以我们就倾向于说这一代的产品经理大概率可能是算法或者模型出身，他又比较，他又有比较好的产品或者业务的sense。就不然的话你就没法利用好关键的模型的红利，那也无法判断好这个未来 6 ~ 12 个月模型的变化。嗯，所以肯定倾向于说从模型，比较懂模型的这帮人里面找。
